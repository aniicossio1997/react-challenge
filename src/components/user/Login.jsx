...
const Login = (props) => {
  const { isLogged, error, handleLogin, guestUser } = userUser();
    ...
    <>
      <div className="row justify-content-center mt-5 pb-2">
        <div className="m-auto col-12 col-sm-8 col-md-6 col-xl-6 border border-secondary pb-5 border-radius rounded-sm color-bg-t">
          <h3 className="mt-3 text-center border-bottom border-secondary p-2 text-uppercase">
            Log Into SuperHero
          </h3>
          {error.type && (
            <Alert typeClass={error.type} title="upss" body={error.message} />
          )}
